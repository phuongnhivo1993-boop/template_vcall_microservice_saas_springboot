...
public class InvoiceController {
    ...
    public ResponseEntity<List<InvoiceResponse>> getSubscriberInvoices(@PathVariable UUID subscriberId) {
        return ResponseEntity.ok(billingService.getInvoiceHistory(subscriberId));
    }
